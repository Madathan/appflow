...
const Sidebar = ({ open, setOpen, menus }) => {
  ...
  return (
    <section className='flex flex-col text-white text-sm h-full'>
      {/* Scrollable menu */}
      <div
        className={`transition-all duration-1000 ease-in-out ${!open ? 'bg-[--third]' : 'bg-[--primary]'} h-full p-3 ${open ? 'w-60' : 'w-16'} px-2 custom-scrollbar`}
      ...
      <div className='flex items-center p-3 bg-[--primary] w-full transition-all duration-1000 ease-in-out'>
