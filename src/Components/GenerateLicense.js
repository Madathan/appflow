        ...
        <div className='mb-8 '>
          ...
          <div className='grid gap-16 grid-cols-1 lg:grid-cols-2'>
            <div className='lg:p-6 px-3 py-2 rounded-[15px] bg-white border border-gray-100 shadow-xl'>
              <h1 className={`text-center lg:py-3 pb-4  text-black text-[27px] `}>Generate <span className=''>New</span> <span className='text-[--second]'>License</span></h1>
                ...
                <div className="grid gap-6 mb-6 grid-cols-2">
                  <div>
                    <label htmlFor="phone_number" className="block mb-2 mt-2  text-sm dark-text-black">Phone Number</label>
                    <input type="text" id="phone_number" name="phone_number" value={formData.phone_number} onChange={handleChange} className="border border-gray-400 border-2 text-gray-900 text-sm rounded-lg focus:ring-gray-400 focus:border-[--second] block w-full" required />
                  </div>
                  <div>
            ...
            <div className='p-6 rounded-[15px] bg-white border border-2 shadow-xl border-gray-200'>
              <h1 className={`text-center py-3 pb-4  text-black text-[27px] `}>Enter <span className=''>Meta</span> <span className='text-[--second]'>Credentials</span></h1>
                <div className='mb-8'>
                  <label htmlFor="phone_number_id" className="block mb-2 text-sm  dark-text-black">Phone Number ID</label>
                  <input type="text" id="phone_number_id" name="phone_number_id" value={formData.phone_number_id} onChange={handleChange} className="border border-gray-400 border-2 text-gray-900 text-sm rounded-lg focus:ring-gray-400 focus:border-[--second] block w-full " required />
                </div>
                <div className='mb-10'>
                  <label htmlFor="whatsapp_id" className="block mb-2 text-sm  text-gray-900 dark-text-black">Whatsapp Business Account ID</label>
                  <input type="text" id="whatsapp_id" name="whatsapp_id" value={formData.whatsapp_id} onChange={handleChange} className="border border-gray-400 border-2 text-gray-900 text-sm rounded-lg focus:ring-gray-400 focus:border-[--second] block w-full " required />
                </div>
                <div className='mb-1'>
                  <label htmlFor="access_token" className="block mb-2 text-sm  dark-text-black">Permanent Access Token</label>
                  <input type="text" id="access_token" name="access_token" value={formData.access_token} onChange={handleChange} className="border border-gray-400 border-2 text-gray-900 text-sm rounded-lg focus:ring-gray-400 focus:border-[--second] block w-full " required />
                </div>
                <div className="mb-8">
